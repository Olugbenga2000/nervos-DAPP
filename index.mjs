...
const ACCOUNT_PRIVATE_KEY = '0x89d1da8ef80d8191c7b095ff753be091f11a419b4e7068fb8fbef8714cdb04bf'; // Replace this with your Tron private key with funds on Layer 2.
const CONTRACT_ABI = [[
    {
      "inputs": [],
...
const CONTRACT_ADDRESS = '0xD11F112E3E7F81b2C6D89d2BB6b0C22C1e75C212';
const TRON_ADDRESS = 'TSJotbhVKGqRcXxJRCiGJEUyuLd5UjSJ78';
...
async function readCall() {
  ...
  const callResult = await contract.methods.name().call();
...
async function writeCall() {
  ...
  const callData = contract.methods.faucet(CONTRACT_ADDRESS, 1000000000).encodeABI();
